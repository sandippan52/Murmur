...
export default function CreateCommunityPost() {
  ...
  const [selected, setSelected] = useState("SUBSCRIBER_ONLY");
  ...
  async function handlePost(e: React.FormEvent) {
    ...
    formData.append("visibility", selected);
      ...
      <div className="lg:sticky lg:top-24 h-fit">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
          ...
          <p className="text-zinc-400 mt-3 leading-7">
            ...
            Choose who can access your post before publishing.
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Give your community post a title..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell your community something..."
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 mt-2">
                ...
                {selected === "PUBLIC"
                  ...
                  : "Only paying subscribers will be able to view this post."}
